...
from . import views
from .views import visualize,login_view, register_view, logout_view, dashboard_view,get_incomes, income_tracker, submit_transaction, delete_income, refresh_token_view
app_name = 'home'
